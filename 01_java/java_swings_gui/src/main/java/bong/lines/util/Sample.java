package bong.lines.util;

import bong.lines.model.Member;
...
public class Sample {
    ...
    public static Vector<Member> getMembers(){
        ...
        members.add(new Member(4,"ArangoJS","bitc5600","jooho","ssar@nate.com", "01022228888", Time.localDateTimeToTimeStamp(LocalDateTime.now())));
